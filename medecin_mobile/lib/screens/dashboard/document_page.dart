...
class DocumentPage extends StatefulWidget {
  ...
  Function setPages;
  Function setId;
  DocumentPage({super.key, required this.id, required this.setPages, required this.setId});
            ...
            children: [
              ...
              Expanded(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return DocumentPatientCard(type: documents[index]['document_type'], date: 'Aujourd\'hui', name: documents[index]['name'], url: documents[index]['download_url'],);
                })),
              Buttons(
