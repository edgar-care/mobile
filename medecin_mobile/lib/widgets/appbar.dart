...
class CustomAppBar extends StatefulWidget {
  ...
  const CustomAppBar(
      {super.key, required this.callback, required this.getSelected});
            ...
            child: Column(
              children: [
                Row(children: [
                  ...
                  Image.asset('assets/images/logo/full-width-color.png',
                      height: 40),
                  const Spacer(),
                  Container(
                    height: 24,
                ...
                if (isOpen)
                  Column(
                    children: [
                      ...
                      CustomCard(
                        isSelected: widget.getSelected() == 0 ? true : false,
                        icon: BootstrapIcons.calendar_week_fill,
                        title: "Agenda",
                        onTap: () {
                          widget.callback(0);
                          setState(() {
                      ...
                      CustomCard(
                          isSelected: widget.getSelected() == 1 ? true : false,
                      ...
                      CustomCard(
                        isSelected: widget.getSelected() == 2 ? true : false,
                        icon: BootstrapIcons.calendar2_check_fill,
                        title: "Rendez-vous",
                        onTap: () {
                          widget.callback(2);
                          setState(() {
