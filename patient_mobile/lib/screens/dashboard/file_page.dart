...
class _AddDocumentState extends State<AddDocument> {
  ...
  Widget build(BuildContext context) {
    return ModalContainer(
      ...
      subtitle: "Séléctioner votre document et son type",
...
class FilterModal extends StatefulWidget {
  Function(String) toggleFilter;
  FilterModal({super.key, required this.toggleFilter});
...
class _FilterModalState extends State<FilterModal> {
  ...
  Widget build(BuildContext context) {
    return ModalContainer(
      title: "Séléctionner un filtre",
      subtitle: "Les filtres sont cumulables",
      icon: const IconModal(
        icon: Icon(
      ...
      body: [
        ...
        GestureDetector(
          onTap: () {
            widget.toggleFilter('Certificat');
            Navigator.pop(context);
          },
          child: const Row(
            children: [
        ...
        GestureDetector(
          onTap: () {
            widget.toggleFilter('Ordonnance');
            Navigator.pop(context);
          },
          child: const Row(
            children: [
